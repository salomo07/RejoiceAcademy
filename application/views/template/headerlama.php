    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-header">
        <a class="navbar-brand" style="padding-top: 4px" href="<?php echo base_url();?>">
          <img alt="<?php echo AppNameL; ?>" title="<?php echo AppNameL; ?>" height="37" width="40" src="<?php if(count($REQUEST_URI)>3){echo "../";} ?>assets/img/PSG.png">
        </a>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" style="padding-top: 4px;" data-toggle="dropdown">
              <img src="<?php if(count($REQUEST_URI)>3){echo "../";} ?>assets/img/PSG.png" style="height: 35px; width:35px;" alt="PSG Logo">
